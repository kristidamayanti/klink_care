	...
	<section class="wrapper site-min-height">
		<h3><i class="fa fa-angle-right"></i> Edit Kategori</h3>
			<div class="row mt">
				...
				echo form_open('Adm_galeri/updateCat/'.$hasil->gallerycat_id,$attributes); ?>
					<div class="col-lg-6">
						<div class="form-panel">
							...
							<p align="right">
								...
								<a href="<?php echo site_url('Adm_side_bar/galeri');?>" class="btn btn-danger" style="text-decoration:none;"><i class="fa fa-times"></i>&nbsp;Batal</a>
							</p>
						</div>
					</div>
				</form>
