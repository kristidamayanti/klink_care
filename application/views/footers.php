...
?>
<div class="footer">
    <p>&copy; K-Link Care Foundation 2013 - 2015</p>
...
<script src="<?php echo base_url() ?>bootstrap/js/amazingslider.js"></script>
<script src="<?php echo base_url() ?>bootstrap/js/initslider-1.js"></script>

<script type="text/javascript" src="<?php echo base_url() ?>bootstrap/js/jssor.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>bootstrap/js/jssor.slider.js"></script>
