...
?><div class="row-fluid">
    <div class="span12 subnav">
        <div class="span5 alex menu"><h2>K-Link Care Foundation</h2></div>
        <div class="span4 menu offset3 pull-right"><p>home > K-Link Care Foundation</p></div>          
    </div>
</div>
...
<div class="row-fluid">          
    <div class="span7">
        <br>
        <div class="thumbnail">
            <img src="<?php echo base_url().'images/' ?>kcf-foundation.jpg" alt="">
        </div>
