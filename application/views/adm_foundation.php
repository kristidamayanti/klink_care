			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i>Tentang K-Link Care Foundation</h4>
							<?php
							$attributes = array("class" => "form-horizontal style-form", "name" => "foundation");
							echo form_open('adm_foundation/updateFondi', $attributes);
							...
							?>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<textarea name="isi" rows="20" class="form-control"><?php echo $row->isi; ?></textarea>
									</div>
								</div> <br><br>
								<p align="right">
