			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i>Message From The Founder</h4>
							<?php
							$attributes = array("class" => "form-horizontal style-form", "name" => "msgfounder");
							echo form_open('adm_msgfounder/updateMsg', $attributes);
