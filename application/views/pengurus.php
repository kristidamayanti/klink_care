...
?><div class="row-fluid">
    <div class="span12 subnav">
        <div class="span4 alex menu"><h2>Pengurus</h2></div>
        <div class="span4 menu offset4 pull-right"><p>Home > Pengurus</p></div>          
    </div>
</div>
...
<div class="row-fluid">          
    <div class="span7">
        <br>
        <div class="thumbnail">
            <img src="<?php echo base_url().'images/' ?>pengurus-1.jpg" alt="">
        </div>
        <h3 class="alex white">Penasehat - Dato' DR H MD Radzi Saleh</h3>
        <div class="thumbnail">
            <img src="<?php echo base_url().'images/' ?>pengurus-2.jpg" alt="">
        </div>
        <h3 class="alex white">Ketua - Datin Roziyaton Jamaluddin</h3>
